...
const slice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(loginUser.fulfilled, (s, a) => { s.loading = false; s.user = a.payload.user; s.accessToken = a.payload.accessToken; })
      .addCase(loginUser.rejected, (s, a) => { s.loading = false; s.error = a.payload; })

      // refresh
      .addCase(refreshAccessToken.pending, (s) => { s.loading = true; s.error = null; })
      .addCase(refreshAccessToken.fulfilled, (s, a) => {
          console.log("✅ Refresh success, setting initialized=true",a.payload.accessToken);
        s.loading = false;
      ...
      .addCase(refreshAccessToken.rejected, (s) => {
        ...
        s.user = null;
        s.accessToken = null;
        s.initialized = true; // refresh attempted
      })
